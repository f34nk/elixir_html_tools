defmodule CustomCssBenchee do
  import Meeseeks.CSS

  def floki_find(html) do
    Floki.find(html, ":fl-contains('Lorem ipsum')")
  end

  def modestex_find(html) do
    ModestEx.find(html, ":contains(Lorem ipsum)")
  end
  ...
  def meeseeks_find(html) do
    selector = %ContainsSelector{value: "Lorem ipsum"}
  ...
  def run do
    ...
    Benchee.run(%{
      "0.2k Floki"    => fn ->
        floki_find(file_0_2k)
      end,
      "0.2k Meeseeks"    => fn ->
        meeseeks_find(file_0_2k)
      end,
      "0.2k ModestEx"    => fn ->
        modestex_find(file_0_2k)
      end,

      "0.5k Floki"    => fn ->
        floki_find(file_0_5k)
      end,
      "0.5k Meeseeks"    => fn ->
        meeseeks_find(file_0_5k)
      end,
      "0.5k ModestEx"    => fn ->
        modestex_find(file_0_5k)
      end,
      ...
      "1k Meeseeks"    => fn ->
        meeseeks_find(file_1k)
      end,
      "1k ModestEx"    => fn ->
        modestex_find(file_1k)
      end,
      ...
      "2k Meeseeks"    => fn ->
        meeseeks_find(file_2k)
      end,
      "2k ModestEx"    => fn ->
        modestex_find(file_2k)
      end
    },
      formatters: [
      ...
      formatter_options: [
        html: [file: "output/custom_css_small.html", auto_open: false],
        # csv: [file: "output/custom_css_small.csv"]
      ]
    )
